...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'share@hiung.onmicrosoft.com',
  ...
  protectedRoutes: ['/根目录/share/🔒 Locked'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'xiongjum@outlook.com',
